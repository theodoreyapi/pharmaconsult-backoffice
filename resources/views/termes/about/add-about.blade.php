...
@section('content')
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Apropos de nous</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Apropos de nous</li>
            </ul>
        </div>

        @include('layouts.statuts')

        <div class="card basic-data-table radius-12 overflow-hidden" style="padding: 20px;">
            <form action="{{ route('terms-about.store') }}" method="post" role="form">
                @csrf
