...
@section('content')
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Mentions legales</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Mentions legales</li>
            </ul>
        </div>
        ...
        @if ($abouts == null)
            ...
            <div class="alert alert-warning" role="alert">
                <strong>Oups!</strong> Vous n'avez pas encore ajouté les mentions legales. Veuillez ajouter les
                mentions legales.
            </div>
        @else
            <div class="card basic-data-table radius-12 overflow-hidden">
                <form action="{{ route('terms-mention.update', $abouts->id_politique) }}" method="post">
                    @csrf
                    @method('PATCH')
