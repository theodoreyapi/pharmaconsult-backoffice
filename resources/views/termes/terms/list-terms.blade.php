...
@section('content')
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Conditions generales d'utilisation</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Conditions generales d'utilisation</li>
            </ul>
        </div>
        ...
        @if ($abouts == null)
            ...
            <div class="alert alert-warning" role="alert">
                <strong>Oups!</strong> Vous n'avez pas encore ajouté les termes et conditions. Veuillez ajouter les
