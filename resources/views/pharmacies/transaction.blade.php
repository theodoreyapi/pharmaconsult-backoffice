    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Liste des Transactions</li>
            </ul>
        </div>
                            ...
                            <form action="{{ route('reservation.store') }}" method="post" role="form">
                                ...
                                <div class="row">
                                    <div class="alert alert-warning" role="alert">
                                        <strong>Information!</strong> Le montant maximum autorisé pour un envoi est de
                                    ...
                                    <div class="col-6 mb-20">
                                        ...
                                        <input type="tel" name="phone" class="form-control radius-8" id="name"
                                    ...
                                    <div class="col-6 mb-20">
                                        ...
                                        <input type="number" name="money" class="form-control radius-8" id="name"
