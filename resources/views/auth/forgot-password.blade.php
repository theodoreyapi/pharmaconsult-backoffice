    ...
    <section class="auth forgot-password-page bg-base d-flex flex-wrap">
        <div class="auth-left d-lg-block d-none">
            <div class="d-flex align-items-center flex-column h-100 justify-content-center">
                <img src="{{ URL::asset('') }}assets/images/auth/forgot-pass-img.png" alt="">
            </div>
        </div>
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <p class="mb-32 text-secondary-light text-lg">Saisissez l'adresse e-mail associée à votre compte et
                        nous vous enverrons un lien pour réintialiser votre mot de passe.</p>
                </div>
                <form action="#">
                    @csrf
                    ...
                    <button type="button" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"
                        data-bs-toggle="modal" data-bs-target="#exampleModal">Continuer</button>

                    <div class="text-center">
                        <a href="{{ url('') }}" class="text-primary-600 fw-bold mt-24">Retour à la connexion</a>
                    </div>
        ...
        <div class="modal-dialog modal-dialog modal-dialog-centered">
            <div class="modal-content radius-16 bg-base">
                <div class="modal-body p-40 text-center">
                    <div class="mb-32">
                        <img src="{{ URL::asset('') }}assets/images/auth/envelop-icon.png" alt="">
                    </div>
                    <h6 class="mb-12">Vérifiez votre e-mail</h6>
                    <p class="text-secondary-light text-sm mb-0">Merci, vérifiez votre courrier électrique pour obtenir
                        des instructions pour réinitialiser votre mot de passe</p>
                    <button type="button"
                        class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32">Passer</button>
                    <div class="mt-32 text-sm">
                        <p class="mb-0">Vous n'avez pas reçu d'e-mail? <a href="#"
                                class="text-primary-600 fw-semibold"> Renvoyer</a></p>
                    </div>
                </div>
            </div>
        </div>
