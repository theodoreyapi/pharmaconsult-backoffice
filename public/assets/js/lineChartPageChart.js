  ...
  createChartTwo('zoomAbleLineChart', '#41BA3E');
  // =========================== Zoom able Line Chart End ===============================
  ...
  // =========================== Line Chart With Data labels Start ===============================
    var options = {
        ...
        colors: ['#41BA3E'],  // Set the color of the series
        dataLabels: {
          enabled: true
        },
        stroke: {
  ...
  function createLineChart(chartId, chartColor) {
    var options = {
      ...
      colors: ['#41BA3E', '#FF9F29'],  // Set the color of the series
      dataLabels: {
          enabled: false
      },
      stroke: {
  ...
  createLineChart('doubleLineChart', '#41BA3E');
