  ...
  createChart('new-user-chart', '#41BA3E');
  ...
  createChartTwo('revenue-chart', '#41BA3E');
  ...
  // ================================ Earning Statistics bar chart Start ================================
    var options = {
      ...
      fill: {
          type: 'gradient',
          colors: ['#41BA3E'], // Set the starting color (top color) here
          gradient: {
              shade: 'light', // Gradient shading type
              type: 'vertical',  // Gradient direction (vertical)
              shadeIntensity: 0.5, // Intensity of the gradient shading
              gradientToColors: ['#41BA3E'], // Bottom gradient color (with transparency)
              inverseColors: false, // Do not invert colors
